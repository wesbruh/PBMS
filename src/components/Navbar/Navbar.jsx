...
function Navbar() {
  ...
  const isSpecialServicesActive =
    location.pathname.startsWith("/services/weddings") ||
    location.pathname.startsWith("/services/labor-and-delivery");
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <img
          src="/logo2.png"
          alt="Your Roots Photography Logo"
      ...
      <div className="hidden lg:flex font-serif text-sm md:text-md items-center ml-auto ">
        <div className="flex items-center gap-6">
          ...
          <div className="inline-block relative group">
            ...
            <ul
              className="absolute top-full mt-2 bg-white shadow-xl rounded-md py-2 z-10 max-h-0 opacity-0 overflow-hidden 
            ...
            {profile ? (
              <>
                <Link
                  to="/dashboard"
                  onClick={() => setIsMenuOpen(false)}
                  className="block w-full text-center px-4 py-1.5 bg-[#7E4C3C] text-white rounded-lg hover:bg-[#AB8C4B] transition border border-black"
                >
                  Dashboard
                </Link>
                <button
