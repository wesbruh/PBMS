...
function Sidebar() {
  ...
  const linkStyles = "ml-3 md:ml-8 mt-2 tracking-wide flex items-center gap-3 relative after:content-[''] after:absolute after:left-[-16px] after:w-0 after:h-full after:bg-[#AB8C4B] hover:after:w-1 hover:after:rounded after:transition-all after:duration-0 text-white ";
  ...
  return (
        <nav className='h-full w-auto md:max-w-75 sm:text-md lg:text-lg flex bg-brown rounded-lg'>
