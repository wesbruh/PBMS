...
router.get("/:paymentId", async(req, res) => {
    ...
    doc.end();
        ...
        doc
            .fillColor(dark)
            .fontSize(16)
            .text(`No. ${payment.id.slice(0, 8)}`, 80, y + 45);
           

        doc
            .text(
            payment.paid_at ? new Date(payment.paid_at).toLocaleDateString() : "-", 80, y + 70);
        ...
        doc
            .font("Times-Bold")
            .text(
            `${payment.currency} $${Number(payment.amount).toFixed(2)}`, 340, 540,
        ...
        doc
            ...
            .fontSize(18)
            .text(
            `${payment.currency} $${Number(payment.amount).toFixed(2)}`,80, 615, 
